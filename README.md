...
接客・販売・立ち仕事に疲れた20代女性向けの、働き方・転職メディア。母体はTikTok「あしたの働き方ノート（[@hatarakikata_note](https://www.tiktok.com/@hatarakikata_note)）」。

「接客・立ち仕事から、事務・在宅・土日休みの仕事へ」をコンセプトに、つらさへの共感／事務という選択肢／志望動機・面接の例文／会社の見分け方／転職の進め方／転職後のリアルを、やさしく具体的に届けます。本サイトはA8.net等ASPの媒体審査通過と、転職アフィリエイトの土台づくりを目的としています。
...
slug: "english-slug"
category: "tsurai"   # tsurai(つらい) / shokushu(選択肢) / template(テンプレ) / kaisha(会社選び) / flow(進め方) / real(転職後)
date: "2026-05-06T21:30:00+09:00"     # JST固定・ハードコード（動的時刻にしない）
updated: "2026-05-06T21:30:00+09:00"  # 基本は date と同じ
tags: ["タグ1", "タグ2"]
isPR: false           # アフィ/PRを含むなら true（kaisha/flow/real 系）
related: ["other-slug-1", "other-slug-2"]   # 関連記事（任意。無ければ同カテゴリ自動）
sources:              # 出典（数値の記述には推奨）
  - label: "出典名"
    url: "https://..."
---
```
