...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-stone-200/70 bg-[var(--bg)]/85 backdrop-blur-md">
      ...
      {/* モバイルナビ */}
      {open && (
        <nav className="border-t border-stone-200 bg-white/95 px-5 py-3 lg:hidden">
