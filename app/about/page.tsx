  ...
  return (
    <Container size="prose" className="py-8">
      ...
      <div className="prose prose-neutral mt-8 max-w-none">
        ...
        <p>
          本サイト「{siteConfig.name}」は、「働き方を変える」を応援する、働き方・転職の情報メディアです。
          職種を問わず、いまの働き方に疲れた人が「自分に合う働き方」へ移るための情報を発信しています。
        </p>

        <h2>運営の目的・方針</h2>
        <p>
          「いまの働き方に違和感やしんどさを感じている人が、自分に合う仕事・働き方へ変える」のを応援することを目的に、
          つまずきやすいポイントをやさしく具体的にまとめています。未経験からの転職も、年収アップ・キャリアアップを狙う転職も、
          どちらも視野に入れて扱います。
        </p>
        <ul>
          <li>いまの働き方の「しんどい」への共感と、我慢しなくていい理由</li>
          <li>在宅・リモート・雇用形態・職種転換・年収アップなど、働き方の選択肢</li>
          <li>志望動機・自己PR・面接・お礼メールの「そのまま使える例文」</li>
          <li>ホワイトな会社の見分け方、転職の進め方、エージェント・スカウトの使い方</li>
        </ul>
